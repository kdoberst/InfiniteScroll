...
describe('KeyboardShortcuts', () => {
  ...
  it('should render all keyboard shortcuts', () => {
    ...
    expect(screen.getByText('Move focus to first focusable element in the feed')).toBeInTheDocument();
    
    expect(screen.getByText('Control + End')).toBeInTheDocument();
    expect(screen.getByText('Move focus to first focusable element after the feed')).toBeInTheDocument();
  });
